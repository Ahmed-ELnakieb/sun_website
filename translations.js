...
const translations = {
  ar: {
    // Page Meta
    page_title: "شركة صن للاستيراد والتصدير - شريككم الموثوق في تجارة القمح والسلع الأساسية",
    page_description: "شركة صن للاستيراد والتصدير - شريككم الموثوق في استيراد وتصدير القمح والحبوب والسلع الأساسية. خبرة طويلة وجودة عالية في الخدمة.",
    ...
    // Hero Section
    hero_title: "مرحباً بكم في شركة صن",
    hero_subtitle: "شريككم الموثوق في تجارة القمح والسلع الأساسية",
    hero_discover: "اكتشف خدماتنا",
    hero_contact: "تواصل معنا",
    company_subtitle: "للاستيراد والتصدير",
    
    // Features Section
    features_title: "لماذا تختار شركة صن؟",
    ...
    about_text1: "تأسست شركة صن للاستيراد والتصدير لتعمل في مجال استيراد وتصدير الحاصلات الزراعية والسلع الأساسية، وقد أصبحت تمتلك أقوى فريق عمل ينتقي المحاصيل ذات الجودة العالية ويقوم بفرزها وتنقيتها وتصديرها لكل بلدان العالم مثل العراق ورومانيا وتركيا وإسبانيا وغيرها.",
    ...
    why_choose_title: "لماذا تختار شركة صن؟",
    ...
    // Administration
    admin_title: "الإدارة",
    admin_subtitle: "تعرف على فريق الإدارة المتميز الذي يقود شركة صن نحو النجاح والتميز في مجال الاستيراد والتصدير",
    ...
    admin_ceo_modal_desc1: "بخبرة تمتد لأكثر من <span class=\"font-bold text-purple-600\">12 سنة<\/span> في مجال التجارة الدولية والقطاع الزراعي، يقود <span class=\"font-bold text-purple-600\">أحمد عبدالفتاح متولي<\/span> شركة <span class=\"font-bold text-purple-600\">صن<\/span> برؤية استراتيجية طموحة تهدف إلى تحقيق النمو المستدام والريادة في الأسواق العالمية.",
